...
<div class="i_bg bg_color">
    ...
    <div class="m_content">
        ...
        <div class="m_right">
                    ...
                    <tr valign="top">
                        ...
                        <td>
                            <div class="m_user"><%
                                ...
                                if(object != null){
                                    User user = (User)object;
                                    //session.getAttribute("userId",user.getId());
            ...
            <table border="0" class="mon_tab" style="width:870px; margin-bottom:20px;" cellspacing="0" cellpadding="0">
                <tr>
                    <td width="40%">用户ID：<span style="color:#555555;"><%out.print(user.getId());%></span></td>
                    <td width="60%">邀请人：<span style="color:#555555;">邀请人姓名</span></td>
                </tr>
                <tr>
                    <td>电&nbsp; &nbsp; 话：<span style="color:#555555;"><%out.print(user.getMobile());%></span></td>
                    <td>邮&nbsp; &nbsp; 箱：<span style="color:#555555;"><%out.print(user.getEmail());%></span></td>
                </tr>
                <tr>
