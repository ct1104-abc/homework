...
<div class="i_bg bg_color">
    ...
    <div class="m_content">
        ...
        <div class="m_right">
            <p></p>
            <form id="addressForm" action="address.do">
            ...
            <div class="address">
                <%
                    ...
                    Object oAddress = session.getAttribute("address");
                    List<Address> address = (List<Address>) oAddress;
                ...
                <table border="0" class="add_t" align="center" style="width:98%; margin:10px auto;" cellspacing="0" cellpadding="0">
                    <tr>
                        <td colspan="2" style="font-size:14px; color:#ff4e00;"><%=address1.getRemark()%></td>
                    </tr>
                    <tr>
