        ...
        <div class="two_bg">
            ...
            <table border="0" class="car_tab" style="width:1110px;" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    ...
                    <td align="center">${items.value}</td>
                    <td align="center" style="color:#ff4e00;">￥${items.key.price}</td>
                    <td align="center">26R</td>
                </tr>
                </c:forEach>
                <tr>
                    <td colspan="5" align="right" style="font-family:'Microsoft YaHei';">
                        商品总价：￥${sessionScope.cost} ； 返还积分 56R
                    </td>
                </tr>
            </table>
            ...
            <table border="0" class="peo_tab" style="width:1110px;" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    ...
                    <td>${sessionScope.userAddress}</td>
            ...
            <table border="0" style="width:900px; margin-top:20px;" cellspacing="0" cellpadding="0">
                <tr>
                    <td align="right">
                        该订单完成后，您将获得 <font color="#ff4e00">${sessionScope.cost}</font> 积分 ，以及价值 <font color="#ff4e00">￥0.00</font> 的红包 <br />
                        商品总价: <font color="#ff4e00">￥${sessionScope.cost}</font>  + 配送费用: <font color="#ff4e00">￥15.00</font>
                    </td>
                </tr>
                <tr height="70">
                    <td align="right">
                        <b style="font-size:14px;">应付款金额：<span style="font-size:22px; color:#ff4e00;">￥${sessionScope.cost+15}</span></b>
                    </td>
                </tr>
                <tr height="70">
                    <td align="right"><a href="BuyCar_Three.jsp"><img src="images/btn_sure.gif" /></a></td>
                </tr>
            </table>
