...
<div class="wrap">
    ...
    <div class="login logns produce">
        ...
        <dl>
            <dd >
                <label>名称：</label>
                <input type="text" name="pname" class="inputh lf" value="" />
                <div class="xzkbg spbg lf"></div>
            </dd>
            <dd>
                <label>起拍价：</label>
                <input type="text" name="beginprice" class="inputh lf" value="" />
                <div class="lf red laba">必须为数字</div>
            </dd>
            <dd>
                <label>底价：</label>
                <input type="text" name="endprice" class="inputh lf" value="" />
                <div class="lf red laba">必须为数字</div>
            </dd>
            <dd>
                <label>开始时间：</label>
                <input type="text" name="beginTime" class="inputh lf" value="" />
                <div class="lf red laba">格式：2010-05-05 12:30:00</div>
            </dd>
            <dd>
                <label>结束时间：</label>
                <input type="text" name="endTime" class="inputh lf" value="" />
